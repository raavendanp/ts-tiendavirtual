...
<html lang="en">
	<head>
		...
		<title>Electro - HTML Ecommerce Template</title>
 		...
 		<!-- Slick -->
 		<link type="text/css" rel="stylesheet" href="{{ asset('bootstrap/css/slick.css')}}"/>
 		<link type="text/css" rel="stylesheet" href="{{ asset('bootstrap/css/slick-theme.css')}}"/>

 		<!-- nouislider -->
 		<link type="text/css" rel="stylesheet" href="{{ asset('bootstrap/css/nouislider.min.css')}}"/>

 		<!-- Font Awesome Icon -->
		 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

 		<!-- Custom stlylesheet -->
 		<link type="text/css" rel="stylesheet" href="{{ asset('bootstrap/css/style.css')}}"/>
					...
					<ul class="header-links pull-right">
                        ...
                        @else
                            <li class="nav-item dropdown">
								...
								<li><a href="/public/logout"><i class="fa fa-user-o"></i> logout</a></li>
